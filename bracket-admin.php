...
$bracket = mysql_result(mysql_query("SELECT scoreboard_html FROM scoreboard WHERE pk_key_id = 4"),0);

if($_POST && isset($_POST["text"])) {
	mysql_query("UPDATE scoreboard SET scoreboard_html = '".trim($_POST[text])."' WHERE pk_key_id = 4");
...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="bracket.css?v=201" />
	<script src="//ajax.googleapis.com/ajax/libs/jquery/1.10.2/jquery.min.js"></script>
	<script src="jquery.plugin.min.js"></script>
	<script src="jquery.countdown.min.js"></script>
</head>
<body id="admin">
	<img src="bracket-logo.png?v=4" alt="" id="logo"/>
	...
	<div id="bracket-wrapper">
		...
		<table>
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td class="player semifinal right">
					<p><input spellcheck="false" type="text" class="player-input" name="player[<?=$x;?>]" value="" /></p>
				</td>
				<td class="border-left"></td>
			</tr>
			<tr>
				<td class="player no-right-border">
					<p><input spellcheck="false" type="text" class="player-input" name="player[<?=$x;?>]" value="" /></p>
					<em><input spellcheck="false" type="text" class="deckname" name="deckname[<?=$x++;?>]" value="" /></em>
				</td>
				<td class="border-right"></td>
			...
			<tr>
				...
				<td class="player final right"><p><input spellcheck="false" type="text" class="player-input" name="player[<?=$x;?>]" value="" /></td>
				<td></td>
				<td></td>
			</tr>
			<tr>
